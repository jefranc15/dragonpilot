...
QUERY_RADIUS = 500  # mts. Radius to use on OSM data queries.
MIN_DISTANCE_FOR_NEW_QUERY = 150  # mts. Minimum distance to query area edge before issuing a new query.
